...
# @Last Modified time: 2016-11-11 15:01:38
...
class DIGPriceExtractor():
    ...
    def extract(self, text):
        ...
        ans[PE_DICT_NAME_PPH] = 1*sum(price_per_hour)/len(price_per_hour) if len(price_per_hour) else 0
